...
module RubyAMF
  module Configuration
    ...
    # :type           # Used to specify the type of VO, valid options are 'active_record', 'custom',  (or don't specify at all)
    ...
    #
    # Alternately, you can place mappings in a model as follows:
    #
    ...
    # end
    #
    # Now, to register these classes you simply register using the fully qualified path name of the ruby class:
    #
    # ClassMappings.register_by_class_names(["User", "MyPackage::MyClass"])
    #
    # To use rubyamf_mapping in a custom class, you must extend it as follows, and define the method encode_amf
    # in the model to utilize the mapping.
    #
    # class MyRubyModel
    ...
    #                :associations=> ["addresses", "credit_cards"],
    #                :methods => ["friends"],
    #                :populator => "MyRubyModelPopulator"
    # end

    ClassMappings.register_by_class_names(["Post", "PostAuthor", "Comment", "Category"])
